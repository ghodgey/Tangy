...
namespace Tangy.Controllers
{
    public class MenuItemsController : Controller
    {
        ...
        [BindProperty]
        public MenuItemViewModel MenuItemVM { get; set; }//used on any post request
        ...
        public async Task<IActionResult> CreatePost()
        {
            ...
            //Image being saved
            string webRootPath = _hostingEnvironment.WebRootPath; //retrieves wwwroot folder
            ...
            if (files[0] != null && files[0].Length > 0)
            {
                ...
                var extension = files[0].FileName
                    .Substring(files[0].FileName.LastIndexOf("."), files[0].FileName.Length - files[0].FileName.LastIndexOf("."));
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (files[0] != null && files[0].Length > 0)
                    {
                        ...
                        var extension_New = files[0].FileName
